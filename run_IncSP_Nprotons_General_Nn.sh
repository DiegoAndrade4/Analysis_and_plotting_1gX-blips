...
# script to run IncSP_Nprotons_General_Nn_v1.C with the indicated input arguments

#SIGNAL
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIGNAL_Nn_TEST", 
...
#SIGNAL_BTB
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIGNAL_BTB_Nn_TEST",
...
#SIGNAL_CRT
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIGNAL_CRT_Nn_TEST",
...
#SIGNAL_CRT_BTB
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIGNAL_CRT_BTB_Nn_TEST",
...
#SIDEBAND
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIDEBAND_Nn_TEST",
...
#SIDEBAND_BTB
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIDEBAND_BTB_Nn_TEST",
...
#SIDEBAND_CRT
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIDEBAND_CRT_Nn_TEST",
...
#SIDEBAND_CRT_BTB
root -l -b -q 'IncSP_Nprotons_General_Nn_v1.C("SIDEBAND_CRT_BTB_Nn_TEST",
